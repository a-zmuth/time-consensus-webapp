...
*   **External World Text:** This is the "ground truth" that agents will compare their memories against. You can:
    *   Type or paste your own text into the text area.
    *   Click **"Auto-Generate External World"** to populate it with sample text.
